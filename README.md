...
## 📝 Giới thiệu đồ án
Đồ án tập trung vào việc xây dựng và so sánh các kiến trúc học sâu tiên tiến nhất cho bài toán Phát hiện vật thể (Object Detection) trên tập dữ liệu [...]. 
...
👉 Mở file link data.txt để lấy đường dẫn Google Drive. Ta cần tải về và đặt chúng vào đúng cấu trúc thư mục tương ứng trước khi chạy thử nghiệm.

## 🚀 Hướng dẫn Cài đặt & Sử dụng
1. Cài đặt môi trường
Đảm bảo ta đã cài đặt Python (khuyến nghị phiên bản 3.9+). Mở Terminal/Command Prompt tại thư mục gốc của dự án và chạy lệnh sau để tải các gói thư viện cần thiết:
```
pip install -r requirements.txt
```
2. Thử nghiệm trên Jupyter Notebook
Dự án cung cấp sẵn 2 phiên bản mã nguồn để mọi người có thể xem lại quá trình huấn luyện hoặc tự test mã:
